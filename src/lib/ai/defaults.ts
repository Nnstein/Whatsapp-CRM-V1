...
export function buildSystemPrompt(args: {
  ...
  const parts: string[] = [
    ...
    'Language & Dialect Guidelines: Always detect the language of the customer\'s message and reply in that exact language. ' +
      'If the customer writes in Arabic (including Gulf Arabic / Khaleeji dialect, e.g. "شلونك", "أبشر", "يا هلا", "مشكور"), reply in polite, warm, and natural Gulf Arabic. ' +
      'If the customer writes in Hindi (or Romanised Hinglish, e.g. "Namaste", "kaise ho", "kya price hai"), reply in clear, polite Hindi/Hinglish. ' +
      'If the customer writes in English, reply in English. Keep it concise, professional, and friendly, suitable for WhatsApp; ' +
